...
movie_genre = db.Table("movie_genre", db.metadata,
                       db.Column('movie_id', db.ForeignKey('movies.movie_id')),
                       db.Column('genre_id', db.ForeignKey('genres.genre_id')),
                       )
...
class Movies(db.Model):
    ...
    directors = db.relationship("Directors", secondary=movie_director)
    id_genre = db.relationship("Genres", secondary=movie_genre)
